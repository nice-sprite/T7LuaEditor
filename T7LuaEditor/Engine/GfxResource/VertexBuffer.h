...
HRESULT CreateDynamicVertexBuffer(ID3D11Device* device, ID3D11Buffer** ppBuffer, int reserveSize) 
{
...
template<typename VertexType>
HRESULT CreateDynamicVertexBuffer(ID3D11Device* device, ID3D11Buffer** ppBuffer, VertexType* initialData, int reserveSize) 
{
    D3D11_BUFFER_DESC bd{};
    bd.ByteWidth = sizeof(VertexType) * reserveSize;
    bd.Usage = D3D11_USAGE_DYNAMIC;
...
template<typename VertexType>
void BindDynamicVertexBuffers(ID3D11DeviceContext* context, ID3D11Buffer** buf)
{
...
template<typename VertexType> 
void UpdateDynamicVertexBuffer(ID3D11DeviceContext* context, ID3D11Buffer* buf, VertexType* vertexData, size_t vertCount)
{
...
template<typename VertexType>
void AppendDynamicVertexBuffer(ID3D11DeviceContext* context, ID3D11Buffer* buf, VertexType* vertexData, size_t vertCount, size_t offset)
{
